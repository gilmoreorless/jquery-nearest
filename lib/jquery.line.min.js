 ...
 */
;(function(a,b){function e(a,b,c){var e=[a.x,a.y,b.x,b.y,c.w,c.h].join(",");if(d[e])return d[e];var f=Math.abs(b.x-a.x),g=Math.abs(b.y-a.y),h=!f||!g?f||g:Math.sqrt(f*f+g*g),i=Math.min(a.x,b.x),j=Math.min(a.y,b.y),k=i+f/2,l=j+g/2,m,n=d[e]={left:k-h/2,top:l,width:h};c.w>1&&(n.width-=c.w-1),c.h>1&&(n.top-=c.h/2),n.left-=c.l,n.top-=c.t,n.left=Math.round(n.left),n.top=Math.round(n.top),n.width=Math.round(n.width),f?g?m=(180+Math.atan2(a.y-b.y,a.x-b.x)*180/Math.PI+360)%360:m=a.x<b.x?0:180:m=a.y<b.y?90:270,n.transform="rotate("+m+"deg)";return n}function c(a){if(a.x===b&&a.y===b)return!1;a.x=parseFloat(a.x)||0,a.y=parseFloat(a.y)||0;return a}var d={};a.line=function(b,d,f){b=c(b),d=c(d);if(!b||!d)return!1;var g=a.extend({},a.line.defaults,f||{}),h=g.elem?a(g.elem):a("<div/>",{"class":g.className}),i={position:"absolute",backgroundColor:g.lineColor,width:1,height:g.lineWidth},j;h.css(i),h[0].parentNode||h.appendTo("body"),j=e(b,d,{w:h.outerWidth(),h:h.outerHeight(),l:parseFloat(h.css("marginLeft"))||0,t:parseFloat(h.css("marginTop"))||0}),h.css(j);return h},a.line.defaults={elem:"",className:"jquery-line",lineWidth:1,lineColor:"#000"}})(jQuery);
/*
